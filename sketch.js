...
function setup() {
  ...
  globe2 = createImg("Imagen1.png");
  globe2.position(500,400);
  globe2.size(120,120);
  globe2.mouseClicked(airblow2);
...
function gameOver(){
  swal( { //Clave de título
     title: `Perdiste`,
      //Clave de texto
       text: "Juega de nuevo",
        //Ruta de imagen con piratas ganando
         imageUrl: "https://image.shutterstock.com/image-vector/illustration-broken-watermelon-260nw-1995976370.jpg",
          //Tamaño de imagen
           imageSize: "150x150",
